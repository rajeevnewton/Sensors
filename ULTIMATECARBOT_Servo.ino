...
void setup() {
  ...
  Serial.println("WELCOME BACK SIR ALL SYSTEMS ARE READY WITHIN FEW SECONDS!");
  delay(400);
  Serial.println("LOADING..........");
  delay(400);
  Serial.println("YOUR ROBOT IS READY");
}
...
void servop1(){
    myservo.write(0);
    Serial.println("servo p1");

}

void servop2(){
    myservo.write(180);
    Serial.println("servo p2");
