...
const char* ssid = "ACT105485077527";
const char* password = "Smilydad@1963";
...
void handleCar() {
  ...
  switch (BtnValue) {
    case 1: // sola donuş
      motorSpeed(512, LOW, LOW, 512, HIGH, LOW);
      SolSinyal = 1;
      digitalWrite(Led1_pin, HIGH);
      break;
    case 2: // düz ileri
      motorSpeed(512, HIGH, LOW, 512, HIGH, LOW);
      SolSinyal = 0;
      SagSinyal = 0;
      ...
      break;
    case  3:// saga donuş
      motorSpeed(512, HIGH, LOW, 512, LOW, LOW);
      SagSinyal = 1;
      digitalWrite(Led2_pin, HIGH);
      break;
    case  4:// tam sola donuş
      motorSpeed(512, LOW, HIGH, 512, HIGH, LOW);
      SolSinyal = 1;
      digitalWrite(Led1_pin, HIGH);
      break;
    case 5: // stop
      ...
      break;
    case  6://
      motorSpeed(512, HIGH, LOW, 512, LOW, HIGH);
      SagSinyal = 1;
      digitalWrite(Led2_pin, HIGH);
      break;
    case 7://sol geri
      motorSpeed(512, LOW, LOW, 512, LOW, HIGH);
      break;
    case 8:// tam geri
      motorSpeed(512, LOW, HIGH, 512, LOW, HIGH);
      break;
    case 9:// sag geri
      motorSpeed(512, LOW, HIGH, 512, LOW, LOW);
    default:
      break;
  }
  if (BtnValue > 7)
  ...
  message += "<html> <head> <title>WIFI ROBOT CAR</title><head>";
